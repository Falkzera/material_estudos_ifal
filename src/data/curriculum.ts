...
const subjects: Subject[] = [
  // ═══════ 1º PERÍODO ═══════
  { id: 'fusi', name: 'Fundamentos de Sistemas de Informação', slug: 'fundamentos-si', code: 'FNSI', period: 1, axis: 'FB', hours: 80, hasContent: false },
  ...
  { id: 'fgeo', name: 'Fundamentos da Gestão Organizacional', slug: 'fundamentos-gestao-organizacional', code: 'FNGO', period: 2, axis: 'FB', hours: 80, hasContent: false },
  { id: 'aocp', name: 'Arquitetura e Organização de Computadores', slug: 'arquitetura-organizacao-computadores', code: 'ARQC', period: 2, axis: 'FPG', hours: 80, hasContent: false },
  { id: 'lpgm', name: 'Linguagem de Programação', slug: 'linguagem-programacao', code: 'LNPG', period: 2, axis: 'FPG', hours: 80, hasContent: true },
  { id: 'sorg', name: 'Sociologia das Organizações', slug: 'sociologia-organizacoes', code: 'SCOG', period: 2, axis: 'FHS', hours: 80, hasContent: false },

  // ═══════ 3º PERÍODO ═══════
  { id: 'etap', name: 'Estatística Aplicada', slug: 'estatistica-aplicada', code: 'ESTA', period: 3, axis: 'FB', hours: 80, hasContent: false },
  { id: 'fdbd', name: 'Fundamentos de Banco de Dados', slug: 'fundamentos-banco-dados', code: 'FNBD', period: 3, axis: 'FPG', hours: 80, hasContent: false },
  ...
  // ═══════ 4º PERÍODO ═══════
  { id: 'ihcc', name: 'Interação Humano-Computador', slug: 'interacao-humano-computador', code: 'INHC', period: 4, axis: 'FPG', hours: 80, hasContent: false },
  ...
  { id: 'frdc', name: 'Fundamentos de Redes de Computadores', slug: 'fundamentos-redes-computadores', code: 'FNRC', period: 4, axis: 'FPG', hours: 80, hasContent: false },
  { id: 'poob', name: 'Programação Orientada a Objetos', slug: 'programacao-orientada-objetos', code: 'PROO', period: 4, axis: 'FPG', hours: 80, hasContent: false },
  { id: 'gpti', name: 'Gestão de Pessoas em TI', slug: 'gestao-pessoas-ti', code: 'GPTI', period: 4, axis: 'FB', hours: 40, hasContent: false },

  // ═══════ 5º PERÍODO ═══════
  { id: 'gvti', name: 'Governança em Tecnologia da Informação', slug: 'governanca-ti', code: 'GOTI', period: 5, axis: 'FPG', hours: 80, hasContent: false },
  ...
  { id: 'pint', name: 'Projeto Integrador', slug: 'projeto-integrador', code: 'PINT 1', period: 5, axis: 'EXT', hours: 40, hasContent: false },
  { id: 'pgwb', name: 'Programação Web', slug: 'programacao-web', code: 'PWEB', period: 5, axis: 'FPG', hours: 80, hasContent: false },
  ...
  { id: 'gpjt', name: 'Gerência de Projeto', slug: 'gerencia-projeto', code: 'GEPJ', period: 5, axis: 'FPG', hours: 80, hasContent: false },

  // ═══════ 6º PERÍODO ═══════
  { id: 'empd', name: 'Empreendedorismo Digital', slug: 'empreendedorismo-digital', code: 'EMPD', period: 6, axis: 'FB', hours: 80, hasContent: false },
  { id: 'pisi', name: 'Projeto Integrador em SI', slug: 'projeto-integrador-si', code: 'PJSI', period: 6, axis: 'EXT', hours: 80, hasContent: false },
  ...
  // ═══════ 7º PERÍODO ═══════
  { id: 'gsei', name: 'Gestão da Segurança da Informação', slug: 'gestao-seguranca-informacao', code: 'GESI', period: 7, axis: 'FPG', hours: 80, hasContent: false },
  ...
  { id: 'arqs', name: 'Arquitetura de Software', slug: 'arquitetura-software', code: 'ARQS', period: 'optativa', axis: 'FPF', hours: 80, optativeCategory: 'desenvolvimento', hasContent: false },
  { id: 'pdsi', name: 'Processamento Digital de Sinais e Imagens', slug: 'processamento-digital-sinais-imagens', code: 'PDSI', period: 'optativa', axis: 'FPF', hours: 80, optativeCategory: 'desenvolvimento', hasContent: false },
  ...
  { id: 'geco', name: 'Gestão do Conhecimento', slug: 'gestao-conhecimento', code: 'GECO', period: 'optativa', axis: 'FPF', hours: 80, optativeCategory: 'gestao', hasContent: false },
  ...
  { id: 'lsop', name: 'Laboratório de Sistemas Operacionais', slug: 'laboratorio-sistemas-operacionais', code: 'LSOR', period: 'optativa', axis: 'FPF', hours: 80, optativeCategory: 'infraestrutura', hasContent: false },
  ...
  { id: 'etso', name: 'Ética e Sociedade', slug: 'etica-sociedade', code: 'ETCA', period: 'optativa', axis: 'FHS', hours: 40, optativeCategory: 'humanistica', hasContent: false },
];
